...
1. Clone the repo
    ...
    ```sh
    $> git clone ssh://git@gitlab.42mulhouse.fr:422/bdehais/bde-website.git
    ```
...
-   Adjust the CGU/CGV according to any changes (and maybe just..adjust it because it could be better? But I -bdehais- wrote them myself with lot of love so I'm not sure I want to change them myself)
...
See the [open issues](https://gitlab.42mulhouse.fr/bdehais/bde-website/-/issues) for a full list of proposed features (and known issues).
...
-   bdehais - [bdehais](https://profile.intra.42.fr/users/bdehais)
-   bguyot - [bguyot](https://profile.intra.42.fr/users/bguyot)

Mail:

-   bdehais@student.42mulhouse.fr
-   bguyot@student.42mulhouse.fr
