					...
					this.http.get(
						...
						.then(async response => {
							let stud = {
								...
								firstname: response.data.usual_first_name, //might need some fixes : test with Bruno's account voir si cette variable est set sur Bruno ou si il faut la tester
