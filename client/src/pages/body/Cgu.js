	...
	return (
		<>
			...
			<p>
				...
				<b>bde42mulhouse.fr</b>, ci après le "Site", les présentes
				mentions légales stipulant notamment l’identité des différents
			...
			<ul>
				...
				<li>
					Responsabilité technique, conception et développement : Ikar
					GUYOT et Bruno DEHAIS webmaster.bde42mulhouse@gmail.com
				</li>
			</ul>
			<h2>Hébergement</h2>
			<p>
